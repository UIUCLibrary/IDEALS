...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:template name="buildHeader">
        ...
        <xsl:variable name="com_hdl" select="/dri:document/dri:meta/dri:pageMeta/dri:trail[2]/@target"/>
        ...
        <div id="ds-header-sm" class="visible-xs container" role="banner">
            ...
            <div id="user-links">
                ...
                <div class="container" id="toggled-menu">
                    <button class="collapsed btn btn-primary btn-sm" type="button" data-toggle="collapse" data-target="#ds-options-wrapper">
        ...
        <div id="ds-header-wrapper" >
            <div id="ds-header" class="clearfix container" role="banner">
                ...
                <xsl:choose>
                    <xsl:when test="$com='34610' or $request_subhandle='34610'">
                        <img id="ds-header-logo" src="{$theme-path}/images/c2c-logo_606x80.gif" alt="C2C Logo" usemap="#logomap"/>
                    </xsl:when>
                    <xsl:otherwise>
                        <div class="row">
                            <div id="ds-image-group" class="col-sm-7 col-md-8 col-lg-8 hidden-xs">
                                ...
                                <map id="logomap" name="logomap">
                                    ...
                                    <!--Block I link-->
                                    <area shape="rect" coords="299,10,335,56" href="http://illinois.edu/"
                                    ...
                                    <div id="search-place" class="col-sm-3 col-md-3 col-lg-3">
                                        <form accept-charset="UTF-8" action="/search" class="form-inline" id="top_search_form" method="post">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input class="form-control input-sm" type="text" id="input-search">
                                                    <xsl:attribute name="name">
                                                        <xsl:value-of select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@element='search'][@qualifier='queryField']"/>
                                                    </xsl:attribute>
                                                    <xsl:attribute name="placeholder">Search</xsl:attribute>
   ...
   <xsl:if test="$ccLicenseName and $ccLicenseUri and contains($ccLicenseUri, 'creativecommons')">
            ...
            <div id="ds-footer" class="container">
                ...
                <div class="row">
                    ...
                    <div id="ds-footer-links" class="col-xs-12 col-sm-7">
                        ...
                        <a>
                            <xsl:attribute name="href">
                                <xsl:value-of select="/*/dri:meta/dri:pageMeta/dri:metadata[@qualifier='feedbackURL']"/>
                            </xsl:attribute>
    ...
    <xsl:template match="dri:div[@id='ideals-rss']">
        <xsl:variable name="rss1" select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@qualifier='rss+xml'][1]"/>
        <xsl:variable name="rss2" select="/dri:document/dri:meta/dri:pageMeta/dri:metadata[@qualifier='rss+xml'][2]"/>
        <span id="ideals-rss">
            <a href="{$rss2}">
    ...
    <xsl:template match="dri:body">
        ...
        <div id="ds-body" role="main">
            ...
            <xsl:for-each select="//dri:referenceSet[@type='detailList']/dri:reference/@url">
                <xsl:variable name="col" select="substring-before(substring-after(.,'2142/'),'/mets')"/>
                <xsl:if test="$col='769' or $col='770' or $col='771' or $col='773' or $col='14456' or $col='809' or $col='774' or $col='847' or $col='775'">
                    <div style="margin:5px auto;border:1px solid #CCC;background-color:#F6F6F6;padding:0 5px;">
                        <p><span style="font-weight:bold;">Note:</span>This is a student project from a course
                            affiliated with the <a href="http://www.eui.illinois.edu/">Ethnography of the University
                                Initiative</a>. EUI supports faculty development of courses in which students conduct
